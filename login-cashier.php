...
<body>
    ...
    <div class="container box z-depth-2">
        ...
        <form action="login-cashier.php" method="POST" >
            <div class="center-align">
                <i class="large material-icons green-text text-darken-3">group</i>
                <h5> CASHIER LOGIN</h5><br><br>
            </div>
            ...
            <div class="input-field">
                ...
                <input type="password" required name="pass" id=""><br><br><br>
            </div>
...
$conn = mysqli_connect($servername, $username, $password, $database_name);
    ...
    { 
      ...
      $sql_query = "SELECT u.id FROM cashieraccounts u WHERE u.username = '$usename' AND u.password = '$pass'";
      ...
      {       
        ...
        echo "<script>
              ...
              window.location.replace('login-cashier.php');; 
              </script>";
      }
      mysqli_close($conn);
    }
